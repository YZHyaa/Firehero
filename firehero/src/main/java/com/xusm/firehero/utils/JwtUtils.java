...
public class JwtUtils {
    ...
    public static String generateToken(User user, PrivateKey privateKey, int expireMinutes) throws Exception {
        return Jwts.builder()
                .claim(JwtConstans.JWT_KEY_UID, user.getUid())
                .claim(JwtConstans.JWT_KEY_UNAME, user.getUsername())
    ...
    public static User getInfoFromToken(String token, PublicKey publicKey) throws Exception {
        ...
        return new User(
                ObjectUtils.toLong(body.get(JwtConstans.JWT_KEY_UID)),
                ObjectUtils.toString(body.get(JwtConstans.JWT_KEY_UNAME))
        );
    }
